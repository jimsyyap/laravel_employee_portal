...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
                ...
                <div class="sidebar-brand-text mx-3">Your Brand</div>
            </a>
            ...
            <!-- Nav Item - Employee mgt -->
            <li class="nav-item">
                <a class="nav-link" href="index.html">
                    <span>Manager's Portal</span></a>
            </li>
    ...
    {{-- you dont need these as it's in app.js <script src="vendor/bootstrap/js/bootstrap.bundle.min.js"></script> --}}
